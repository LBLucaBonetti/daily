-- The following app users should be removed since their creation date is before many days ago, their last login is null and they have already been notified
...
VALUES (
  ...
  now() - interval '33 days', -- createdAt
  now() - interval '2 days', -- updatedAt
  2, -- entity version
  1, -- AppUser id
  now() - interval '2 days', -- notifiedAt
  0 -- failures
);
...
-- The following app users should be removed since their creation date and last login are before many days ago and they have already been notified
INSERT INTO app_user
VALUES (
  3,
