...
class AppUserRegistrationFilterTests {
    ...
    void givenJwtAuthenticationToken_thenSetAppUserToToken() throws ServletException, IOException {
        ...
        appUserRegistrationFilter.doFilterInternal(httpServletRequest, httpServletResponse, filterChain);
    ...
    @Test
    void givenNoJwtAuthenticationToken_thenNoSetAppUserToToken() throws ServletException, IOException {
