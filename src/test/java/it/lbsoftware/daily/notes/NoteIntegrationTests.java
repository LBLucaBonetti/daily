...
//    noteRepository.save(Note.builder().text("prova1").appUser("prova1").build());
...
//  void test2() {
//    assertEquals(0, noteRepository.findAll().size());
//    noteRepository.save(Note.builder().text("prova2").appUser("prova2").build());
//    assertEquals(1, noteRepository.findAll().size());
//  }
//
//  @Test
//  void test3() {
//    webTestClient.get().uri("/api/notes").exchange().expectStatus().is4xxClientError();
//  }
//
//  @Test
//  void test4(){
