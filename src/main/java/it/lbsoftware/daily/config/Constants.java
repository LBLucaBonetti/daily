...
public final class Constants {
  ...
  public static final String ERROR_MONEY_TAGS_MAX = ERROR_PREFIX + "money.tags.max";
  ...
  public static final int MONEY_TAGS_MAX = 5;
  ...
  public static final int MONEY_OPERATION_TYPE_MAX = 255;
  public static final int MONEY_DESCRIPTION_MAX = 255;
